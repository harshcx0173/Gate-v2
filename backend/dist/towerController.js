...
// Get all towers
exports.getTowers = /*#__PURE__*/function () {
...
// Create new tower
exports.createTower = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(req, res) {
    var _req$body, name, apartments, towerData, newTower, _t2;
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.n) {
        case 0:
          _req$body = req.body, name = _req$body.name, apartments = _req$body.apartments;
          towerData = {
            name: name,
...
// Update tower
exports.updateTower = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3(req, res) {
    var id, _req$body2, name, apartments, tower, _t3;
    return _regenerator().w(function (_context3) {
      while (1) switch (_context3.n) {
        case 0:
          id = req.params.id;
          _req$body2 = req.body, name = _req$body2.name, apartments = _req$body2.apartments;
          _context3.p = 1;
          _context3.n = 2;
          return Tower.findByIdAndUpdate(id, {
            name: name,
...
exports.deleteTower = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4(req, res) {
    var id, deletedTower, _t4;
